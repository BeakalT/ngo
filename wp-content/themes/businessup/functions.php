 ...
 */
	...
	require( $businessup_theme_path . '/customize/customize_control/class-businessup-customize-alpha-color-control.php');
...
function businessup_widgets_init() {
	...
	register_sidebar( array(
		'name'          => esc_html__( 'Sidebar', 'businessup' ),
		'id'            => 'sidebar-1',
		'description'   => '',
	...
	register_sidebar( array(
		'name'          => esc_html__( 'Service Home Widget Area', 'businessup' ),
...
function businessup_register_widgets() {    
	...
	foreach ( $businessup_sidebars as $businessup_sidebar ):
		...
		if( $businessup_sidebar == 'sidebar-slider' ):
            ...
            $businessup_name = __('Slider Section Widgets', 'businessup');
...
function businessup_import_data_notice() {
		?>
			<div class="updated notice is-dismissible">
				<p><?php echo sprintf( esc_html__( 'To Set Excat Replica of Businessup Theme Install %sDemo Import%s.', 'businessup' ), '<a href="' . esc_url( admin_url( 'themes.php?page=businessup-welcome&tab=import_dummy_data' ) ) . '">', '</a>' ); ?></p>
