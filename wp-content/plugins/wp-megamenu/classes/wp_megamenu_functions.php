...
//function plugin_row_meta_callback( $links, $plugin ){
//    if ( strpos( $plugin, 'wp-megamenu.php' ) !== false ) {
//        $actionsLinks =  array(
//            'wpmm_pro' => '<a href="https://www.themeum.com/product/wp-megamenu/" target="_blank">'.__('Upgrade to Pro', 'wp-megamenu').'</a>'
//        );
//
...
//}
//
//add_filter('plugin_row_meta', array('plugin_row_meta_callback'), 10, 2);
