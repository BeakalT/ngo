...
<div id="comments" class="comments-area businessup-card-box padding-20">
	...
	if ( have_comments() ) : ?>
		<div class="businessup-heading-bor-bt">
		<h5 class="comments-title">
			<?php
				printf( // WPCS: XSS OK.
					esc_html( _nx( 'One Comments &ldquo;%2$s&rdquo;', '%1$s Comments', get_comments_number(), 'comments title', 'businessup' ) ),
		...
		<nav id="comment-nav-above" class="navigation comment-navigation" role="navigation">
			<h2 class="screen-reader-text"><?php esc_html_e( 'Comment navigation', 'businessup' ); ?></h2>
			<div class="nav-links">

				<div class="nav-previous"><?php previous_comments_link( esc_html__( 'Older Comments', 'businessup' ) ); ?></div>
				<div class="nav-next"><?php next_comments_link( esc_html__( 'Newer Comments', 'businessup' ) ); ?></div>
